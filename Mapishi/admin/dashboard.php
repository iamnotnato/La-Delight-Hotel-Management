              ...
              <div class="card">
                <div class="card-header card-header-tabs card-header-warning">
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <span class="nav-tabs-title">Dishes:</span>
                ...
                <?php 
                    ...
                    if(mysqli_num_rows($result) > 0)
                    {
                      ...
                      ?>
                      <center><a href="add.php"><input type="button" class="btn btn-sm btn-warning animation-on-hover btn-simple" 
                      name="add" value="Add Product"></a>
                      <br>
                </center>
    </tbody>
                  </table>
