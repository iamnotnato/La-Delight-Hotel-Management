...
<body>
    ...
    <center><a href="home"><img width="25%" src="img/icon.png"></a></center>
        <nav class="uk-navbar uk-margin" uk-navbar>
    <div class="uk-navbar-center">
...
<div uk-slideshow="animation:push; autoplay-interval:3000; autoplay:true; finite:true;">
    ...
    <div class="uk-position-relative uk-visible-toggle uk-dark">
        ...
        <ul class="uk-slideshow-items">
            <li>
                <img src="img/header.png" alt="" uk-cover>
                <div class="uk-overlay uk-text-secondary uk-dark uk-position-center">
       <button class="uk-button uk-button-secondary">INSECTICIDES</button>
        <button class="uk-button uk-button-secondary">KES 2000</button>
    </div>
            </li>
            <li>
                <img src="img/header2.png" alt="" uk-cover>
                 <div class="uk-overlay uk-text-secondary uk-dark uk-position-center">
       <button class="uk-button uk-button-secondary">CEREALS</button>
        <button class="uk-button uk-button-secondary">KES 2000</button>
    </div>
            </li>
            <li>
                <img src="img/header3.png" alt="" uk-cover>
                 <div class="uk-overlay uk-text-primary uk-dark uk-position-center">
        <button class="uk-button uk-button-secondary">ANIMAL FEEDS</button>
 ...
 <div class="uk-position-bottom-center uk-position-small">
        <ul class="uk-thumbnav">
            <li uk-slideshow-item="0"><a href="#"><img src="img/header.png" width="100" alt=""></a></li>
            <li uk-slideshow-item="1"><a href="#"><img src="img/header2.png" width="100" alt=""></a></li>
            <li uk-slideshow-item="2"><a href="#"><img src="img/header3.png" width="100" alt=""></a></li>
        </ul>
    </div>
    </div>
...
<footer class="mdl-mega-footer">
    <div class="mdl-mega-footer__middle-section">
      ...
      <div class="mdl-mega-footer__drop-down-section">
        ...
        <ul class="mdl-mega-footer__link-list">
          <li><a href=""><p class="white-text">How To Shop On MAPISHI POA</p></a></li>
  ...
  First Floor Room Number 102.<br>
    ...
    <div class="mdl-mega-footer__bottom-section float-center">
      <div class="mdl-logo "><center>&copy MAPISHI POA STORES 2019</center></div>
      <ul class="mdl-mega-footer__link-list">
      </ul>
    </div>
