...
<meta name="theme-color" content="LightGray">
    ...
    <title>MAPISHI POA SHOPPING ORDER</title>
...
$sql = "INSERT INTO orders (customer_name, town , phone_number,product_name,quantity,total) 
VALUES ('$customer_name','$town', '$phone_number','$product_name','$quantity','$total')";
