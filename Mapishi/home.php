...
<body>
    ...
    <center><a href="home"><img width="25%" src="images/icon.png"></a></center>
        <nav class="uk-navbar uk-margin" uk-navbar>
    <div class="uk-navbar-center">
...
<div class="table-responsive">
  <table class="uk-table">
    <caption class="uk-text-center">DISHES</caption>
...
<hr class="uk-divider-icon">
<center><h6>ANIMAL FEEDS</h6></center>
<hr class="uk-divider-icon">
...
<hr class="uk-divider-icon">
<center><h6>FERTILIZERS</h6></center>
<hr class="uk-divider-icon">
<div class="uk-child-width-1-4@s uk-grid-small uk-text-center" uk-grid>
  <?php
  $query = "SELECT * FROM products ORDER BY id ASC";
...
<hr class="uk-divider-icon">
<center><h6>INSECTICIDES SPRAYS</h6></center>
<hr class="uk-divider-icon">
<div class="uk-child-width-1-4@s uk-grid-small uk-text-center" uk-grid>
  <?php
  $query = "SELECT * FROM products ORDER BY id ASC";
